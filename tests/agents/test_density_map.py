from fsd.agents.InterFuser import generate_density_map
...
train_pipeline = [
    ...
    dict(
        ...
        with_attr_label=True, # instance names
...
for sample in dl:
    ...
    gt_instances = sample['data_sample'][0].gt_instances_3d
    density_map = generate_density_map(gt_instances, [0, 20, -10, 10], pixels_per_meter = 1)
