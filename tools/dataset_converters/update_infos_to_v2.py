...
def get_empty_instance():
    ...
    instance = dict(
        ...
        # (str, optional): The sample annotation token, e.g, in Nuscenes)
...
def update_nuscenes_infos(pkl_path, out_dir):
    ...
    data_root = osp.dirname(pkl_path)
    ...
    for i, ori_info_dict in enumerate(
        ...
        # get scene token
        sample = nusc.get('sample', temp_data_info['token'])
        temp_data_info['scene_token'] = sample['scene_token']
        ...
        if 'gt_boxes' in ori_info_dict:
            ...
            for i in range(num_instances):
                ...
                empty_instance['id'] = ori_info_dict['gt_ids'][i]
