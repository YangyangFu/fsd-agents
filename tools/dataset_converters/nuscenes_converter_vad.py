...
from tools.data_converters.update_infos_to_v2 import update_nuscenes_infos
from tools.data_converters.create_gt_database import create_groundtruth_database
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmengine.track_iter_progress(nusc.sample):
        ...
        ## TODO: Confirm BOXES from Nuscenes are in nuscene lidar coord
        ...
        if not test:
            ...
            #TODO: change back to Nuscenes box convention??
            gt_boxes_yaw = -(gt_boxes[:,6] + np.pi / 2)
            
            #TODO: coordinate for each
            ...
            for i, anno in enumerate(annotations):
                ...
                for j in range(fut_ts):
                    if cur_anno['next'] != '':
                        ...
                        #TODO: yaw defintiion in NuScenes???
                        # add yaw diff
...
def nuscenes_data_prep(root_path,
    ...
    if version == 'v1.0-test':
        ...
        update_nuscenes_infos(out_dir=out_dir, pkl_path=info_test_path)
        return
