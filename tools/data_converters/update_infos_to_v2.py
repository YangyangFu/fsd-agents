...
#TODO: delete this as it is a temporary solution
def generate_nuscenes_vad_infos(ori_info_dict):
    keys = ['can_bus', 
            'scene_token',
            'frame_idx',
            'valid_flag',
...
def update_nuscenes_infos(pkl_path, out_dir):
    ...
    for i, ori_info_dict in enumerate(
        ...
        if 'gt_boxes' in ori_info_dict:
            ...
            # for vad specific
            temp_data_info['vad'] = generate_nuscenes_vad_infos(ori_info_dict)
