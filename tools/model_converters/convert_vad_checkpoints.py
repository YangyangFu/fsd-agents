...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Convert keys in original checkpoints for VAD')
...
def main():
    ...
    RENAME_PREFIX = {
        ...
        'pts_bbox_head.transformer.reference_points': 'pts_bbox_head.reference_points',
        'pts_bbox_head.transformer.map_reference_points': 'pts_bbox_head.map_reference_points',
        'pts_bbox_head.transformer.can_bus_mlp': 'pts_bbox_head.can_bus_mlp',
    }
