...
class VADHead(DETRHead):
    ...
    def forward(self,
        ...
        if only_bev:  # only use encoder to obtain BEV features, TODO: refine the workaround
            ...
            #NOTE: this transformer is an instance of VADPerceptionTransformer, which includes BEVFormer as encoder, 
            # a detection transformer as decoder, and a MapDetectionTransformer as map decoder.
